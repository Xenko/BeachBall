...
$('#optionsItems').append('<div class="minifloatbox"> <a onclick="BeachBall.SwitchOption(\'BeachAutoClick\')"> <h4>Beach Auto Click</h4> </a> <div id="BeachAutoClickDesc"><div id="ClickRate" style="visibility: hidden;"><a onlick="Beachball.SwitchOption(\'BeachAutoClickRate\')">Test</a></div></div></div>');
